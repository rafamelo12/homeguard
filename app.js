...
app.get("/takepicture", function(req, res) {
    ...
    */
    ...
    /* Creating the functions to handle possible errors and the when the connection
       is established.
    */
    // TODO: implement client.sendmessage on connection, so it sends a message to the server
    // stating the nature of the request and try to modulirize the code so we don't need to
    // repeat it over and over for each service. (By service, we mean take picture and record
    // videos)
